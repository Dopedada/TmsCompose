...
//}
//
//fun Double?.normalFormatOrEmpty(): String {
//    if (this == null) return ""
//    return DecimalFormat("#.###############").format(this)
//}
//
//fun Double.normalFormatOrNull(): String? {
//    return DecimalFormat("#.###############").format(this)
//}
///**
// *公里数转换
...
//}
//
//fun Int.multiply(b: Double): String {
//    val result = toBigDecimal().multiply(b.toBigDecimal()).toDouble()
...
// * double相乘，精确计算,保留两位
// */
//fun Double.multiplyToString(b: Int): String {
